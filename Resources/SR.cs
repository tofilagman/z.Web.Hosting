...
namespace z.Web.Hosting
{
    internal sealed class SR
    {
        ...
        internal const string ErrFailedToStartServerOnPortError =
            "ErrFailedToStartz.Web.HostingServerOnPortError";
        ...
        internal SR()
        {
            ...
            string stringResourcesName = t.Namespace + ".Resources.z.Web.Hosting";
